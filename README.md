# Ilea_Watson_Python_Portfolio
This is a portfolio of python code I completed during BISC 450C
...
```python
df.columns = ['year', 'ranks', 'comany', 'revenue', 'profit']
```
...
```python
# Sometimes we want to look at vartiation in statistical values, such as maximum inflammation per patient,
...
```python
if numpy.sum((max_inflammation_0 == 0) and (max_inflammation_20 == 20)):
...
```
    ...
    Enter the name of the input FASTA file:  BRCA_1.txt
...
```
    ...
    Enter the name of the output file:  BRCA_1_RNA.txt
...
```
    ...
    The RNA sequence has been saved to BRCA_1_RNA.txt
...
```
    ...
    AGCCUACAAGAAAGUACGAGAUUUAGUCAACUUGUUGAAGAGCUAUUGAAAAUCAUUUGUGCUUUUCAGCUUGACACAGGUUUGGAGU
